...
template<typename T>
bool is_more_than_20(tree_elem<T>* curr){
    if(curr->m_data >= 20)
        return true;
    return false;
}
...
int main(){
    ...
    int n;
    std::cout << "enter the cardinality for the first tree:\n";
    ...
    int value;
    std::cout << "Enter "<< n <<" amount of elements :\n";
    ...
    first.print();
    //===========================================================//
    std::cout << "enter the cardinality for the second tree :\n";
    ...
    first.Map(sqr);
    std::cout << "squares of the first tree :\n";
    first.print();

    second.Where(is_more_than_20);
    std::cout << "All items less than 20 that belong to the second tree :\n";
    second.print();

    std::cout << "sum of the modified first tree = " << first.Reduce(sum) << std::endl;
